...
<div class="block-flat">
          ...
          <div class="content">
             ...
             <?php echo form_open_multipart('encode_decode/decrypt_data', ['class'=>'form-horizontal' , 'style'=>'border-radius: 0px !important;']);?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  ...
                  <?php echo form_input(['name'=>'msg','placeholder'=>'Enetr message to decode','class'=>'form-control','value'=>set_value('email')]);?>
                </div>
              </div>
              <div class="foot">
              	<div class="form-group">
              	<!-- <button class="btn btn-default" data-dismiss="modal" type="button">Register</button> -->
		            <div class="col-sm-2 pull-right">
		              	<?php 
		              		...
		              		form_submit(['value'=>'Decode','class'=>'form-control btn btn-primary']);
		              	?>
              		</div>
              	</div>
